...
import time
import pyperclip
#from auto_config import auto_config_g16_g8

def provisionar_g16():
    while True:
        print("\n\033[0;34;40mVocê selecionou a OLT Modelo G16.\n\033[m\n")
        time.sleep(2)
        print("\033[0;32;40mSelecione uma opção:\n")
        print("1 - PROVISIONAMENTO MANUAL")
#        print("2 - PROVISIONAMENTO AUTOMÁTICO")
        print("2 - VERIFICAR DEVICE-TYPEs DA INTELBRAS")
        ...
        if escolha_opção == "1":
            ...
            limite_min_pon_g16 = 1
            limite_max_pon_g16 = 16
            limite_min_posicao_cpe_g16 = 1
            limite_max_posicao_cpe_g16 = 128
            limite_min_line_cpe_g16 = 0
            limite_max_line_cpe_g16 = 2047

            # Adicione aqui as opções específicas para a OLT Modelo G16.
            while True:
                pon_selecionada_g16 = input('\033[0;32;40mEm qual porta PON a CPE está aguardando ser provisionada (1-16)?\n')
                if pon_selecionada_g16.isdigit():
                    pon_selecionada_g16 = int(pon_selecionada_g16)
                    if limite_min_pon_g16 <= pon_selecionada_g16 <= limite_max_pon_g16:
                        break
                print(f'\033[0;31;40mPor favor, insira um valor entre {limite_min_pon_g16} e {limite_max_pon_g16}.\033[m')



            # Solicitar a entrada para "posição_cpe_g16" até que seja válida
            while True:
                posição_cpe_g16 = input(f'\033[0;32;40mEm qual posição da porta PON {pon_selecionada_g16} a CPE irá ficar (1-128)?\n')
                if posição_cpe_g16.isdigit():
                    posição_cpe_g16 = int(posição_cpe_g16)
                    if limite_min_posicao_cpe_g16 <= posição_cpe_g16 <= limite_max_posicao_cpe_g16:
                        break
                print(f'\033[0;31;40mPor favor, insira um valor entre {limite_min_posicao_cpe_g16} e {limite_max_posicao_cpe_g16}.\033[m')
                
            gponSN_g16 = input(f'Qual o GPON-SN do produto que deseja provisionar? - Ex.: "ITBS-12345678" \n')
                
            while True:
                line_g16 = input('\033[0;32;40mQual o número da line que irá usar para esse provisionamento? (0 - 2047)\n')
                if line_g16.isdigit():
                    line_g16 = int(line_g16)
                    if limite_min_line_cpe_g16 <= line_g16 <= limite_max_line_cpe_g16:
                        break
                print(f'\033[0;31;40mPor favor, insira um valor entre {limite_min_line_cpe_g16} e {limite_max_line_cpe_g16}.\033[m')    
...
no ont auto-config
deploy profile rule
aim 0/{pon_selecionada_g16}/{posição_cpe_g16}
permit sn string-hex {gponSN_g16} line {line_g16} default line {line_g16}
active
exit
end
c r s
y
            ...
            while True:
                ...
                print("Voltar ao MENU da OLT G16, voltar ao MENU PRINCIPAL ou deseja SAIR?\n")
                print('\033[0;34;40m1. MENU da OLT G16')
                print('2. MENU PRINCIPAL')
                print('3. SAIR do programa\n\033[m')
                
                
                sair_ou_ficar_g16 = input("\033[0;32;40mDigite o número correspondente à sua escolha:\n")
                
                if sair_ou_ficar_g16 == '1':
                    print('Voltando ao MENU da OLTG16...')
                    time.sleep(2)
                    break
                elif sair_ou_ficar_g16 == '2':
                    print('Voltando ao MENU PRINCIPAL...')
                    time.sleep(2)
                    return
                elif sair_ou_ficar_g16 == '3':
...
"""
            ...
            # Resto do código de verificação de device-types
...
é importante lembrar que na G16 fazemos o provisionamento automático por modelo de device. Então só daria se tem apenas 1 VLAN criada
